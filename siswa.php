...
<html>
<head>
    <title>Data Siswa - Arsip Bimbingan Konseling</title>
    ...
    <style>
        ...
        .btn-back { background: #888; color: #fff; border: none; padding: 7px 22px; border-radius: 4px; font-size: 1em; text-decoration: none; margin-top: 18px; display: inline-block; }
